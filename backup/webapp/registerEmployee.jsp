...
<form action="" method="post" onsubmit="registerEmployee()" id="registerForm" >
	...
	<div class="row">
	  <div class="col">
			<label>First Name  </label><input type="text" name="firstName" class="form-control form-control-sm" id="firstName" placeholder="First Name"  autofocus>
			<label class="clear" id="firstNameError"></label>
	  </div>
	  <div class="col">
			<label>Last Name  </label><input type="text" name="lastName" id="lastName" class="form-control form-control-sm" placeholder="Employee's Father Name"  >
...
function registerEmployee(){
	...
	axios.post(url, obj).then(res=>{ 
		...
		if(error=="validation error"){
			...
			document.querySelector("#pageError").innerHTML = "<font style='font-size:12px' color='red'>"+(err.response.data.errorMessage)+"</font>";
		}
	});
}
